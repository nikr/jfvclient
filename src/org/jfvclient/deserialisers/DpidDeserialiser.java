...
package org.jfvclient.deserialisers;
 ...
 */
public class DpidDeserialiser implements JsonDeserializer<Dpid>{

    @Override
    public Dpid deserialize(JsonElement json, Type typeOfT,
